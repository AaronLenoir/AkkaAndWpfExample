...
Code backing up a blogpost on integrating Akka.NET and WPF. This branch is the final solution I came up with. The starting point is in the "master" branch.
